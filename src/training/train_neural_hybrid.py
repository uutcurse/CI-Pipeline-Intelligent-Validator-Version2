...
def main():
    out_dir = 'experiments/e10_neural_hybrid'
    fig_dir = 'reports/figures/e10_neural_hybrid'
    ...
    reloaded_model = NeuralHybrid(codebert_name='microsoft/codebert-base', freeze_codebert=True).to(device)
